...
```{r warning=FALSE}
  ...
  results[[1]] <- readRDS('./part_results/res1.rds')
  results[[2]] <- readRDS('./part_results/res2.rds')
  results[[3]] <- readRDS('./part_results/res3.rds')
  results[[4]] <- readRDS('./part_results/res4.rds')
  results[[5]] <- readRDS('./part_results/res5.rds')
