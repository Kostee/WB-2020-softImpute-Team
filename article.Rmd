...
Taking into account all the imputations which have been implemented, we can clearly see that two first mentioned ones really stand out. However, we cannot fully compare the other three - due to the fact that missForest failed on three data sets, and mice - up to seven.
...
TO NIŻEJ SIĘ NIE PRZYDA CHYBA, ŚCIEK Z PD2
